...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('assets/layouts/layouts.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('assets/styles/details.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('assets/styles/userui.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('assets/styles/mainyields.css') }}">
